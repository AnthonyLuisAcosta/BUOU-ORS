  ...
  <div>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="flex items-center justify-end px-3 py-4">
        <!--from route('applicant.application.create') to ('application.create')-->
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  ...
                  <!--SAME ROUTE MODIFICATION ABOVE-->
                  <a href="{{ route('application.show', $row->id) }}" class="text-blue-600 hover:text-blue-900 mb-2 mr-2">View</a>
                  <a href="{{ route('application.edit', $row->id) }}" class="text-indigo-600 hover:text-indigo-900 mb-2 mr-2">Edit</a>
                  <!--DELETE BUTTON-->
