  ...
  <div>
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="flex items-center justify-end px-3 py-4">
        <a href="{{ route('registrar.terms.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray disabled:opacity-25 transition ease-in-out duration-150">Add Term</a>
      </div>
      <!--Container-->
            ...
            <tbody>
              ...
              <tr class="text-center">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                  ...
                  @endif
                  <a href="{{ route('registrar.terms.edit', $term->id) }}" class="text-indigo-600 hover:font-bold mr-2">Edit</a>
