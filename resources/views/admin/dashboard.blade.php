        ...
        <div class="flex justify-center">
          <div class="h-max w-full px-4 py-2 lg:px-10 lg:py-4 bg-white rounded-lg shadow-lg ">
            ...
            <div class="text-right">
              <a href="#{{$value->id}}" rel="modal:open" class="inline-flex items-center p-2 sm:px-4 sm:py-2 border border-transparent rounded-md sm:font-semibold text-xs sm:text-sm text-white uppercase tracking-widest text-gray-800 shadow-md bg-amber-200 hover:bg-amber-400 hover:text-gray-200 disabled:opacity-25 transition ease-in-out duration-150">EDIT</a>
            </div>
