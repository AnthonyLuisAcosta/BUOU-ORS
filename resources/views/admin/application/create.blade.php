				...
				<div class="border-b-2 py-4">
					...
					<div class="flex flex-col md:flex-row md:items-center md:justify-between">
						<div class="flex-1">
							...
							<div x-show="step === 2">
								<div class="text-lg font-bold text-gray-700 leading-tight">Upload Requirements</div>
							</div>

							<div x-show="step === 3">
								<div class="text-lg font-bold text-gray-700 leading-tight">Subject Selection</div>
							</div>
						</div>
					...
					<div x-show.transition.in="step === 1">
						...
						<div class="mb-5 grid grid-cols-3 gap-4">
                            ...
                            <div>
							    ...
							    <input type="text"
								class="w-full px-3 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
								placeholder="Joe"
                                name="firstName"
                                id="firstName">
                            </div>
						...
						<div class="mb-5 grid grid-cols-3 gap-4">
                            ...
                            <div>
                                <label for="email" class="font-bold mb-1 text-gray-700 block">Contact Number</label>
                                <input type="number"
                                    class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium"
