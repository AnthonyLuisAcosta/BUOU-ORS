...
class TermsController extends Controller
{
    ...
    public function store(StoreTermRequest $request)
    {
        ...
        Terms::create($input);
        return redirect()->route('registrar.terms.index')->with('success', 'Term Created.');
    }
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($count == 3) {
            ...
            $term->update();
            return back()->with('success', 'Term set as Active.');
        } else {
            $input = $request->all();
            $term->update([
                'year' => $input['year'],
            ...
            return redirect()->route('registrar.terms.index')->with('success', 'Term Updated.');
        }
    }
